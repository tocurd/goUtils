 ...
 * @LastEditTime: 2021-06-04 22:43:52
...
// 当前时间
func (utilTime *Time) GetTime() time.Time {
	return time.Now()
}

// 格式化为:20060102150405
func (utilTime *Time) GetTimeString(t time.Time) string {
	return t.Format(utilTime.TimeFormat)
}

// 格式化为:2006-01-02 15:04:05
func (utilTime *Time) GetNormalTimeString(t time.Time) string {
	return t.Format(utilTime.NormalTimeFormat)
}

// 转为时间戳->秒数
func (utilTime *Time) GetTimeUnix(t time.Time) int64 {
	return t.Unix()
}

// 转为时间戳->毫秒数
func (utilTime *Time) GetTimeMills(t time.Time) int64 {
	return t.UnixNano() / 1e6
}

// 时间戳转时间
func (utilTime *Time) GetTimeByInt(t1 int64) time.Time {
	return time.Unix(t1, 0)
}

// 字符串转时间
func (utilTime *Time) GetTimeByString(timestring string) (time.Time, error) {
	if timestring == "" {
...
// 标准字符串转时间
func (utilTime *Time) GetTimeByNormalString(timestring string) (time.Time, error) {
	if timestring == "" {
		return time.Time{}, nil
	}
...
// 比较两个时间大小
func (utilTime *Time) CompareTime(t1, t2 time.Time) bool {
	return t1.Before(t2)
}

// n小时后的时间字符串
func (utilTime *Time) GetNextHourTime(s string, n int64) string {
...
// 计算俩个时间差多少小时
func (utilTime *Time) GetHourDiffer(start_time, end_time string) float32 {
	var hour float32
...
// 判断当前时间是否是整点
func (utilTime *Time) Checkhours() bool {
